...
class WC_Product_Slider_Legacy_API {
	...
	*/
	...
	public function get_slider_items() {
		...
		$product_results = $this->get_products_cat( $category_id, 'title menu_order', $number_products, 0 );
	...
	public function get_products_cat($catid = 0, $orderby='title menu_order', $number = -1, $offset = 0) {
		$args = array(
			'numberposts'	=> $number,
			'offset'		=> $offset,
			'orderby'		=> $orderby,

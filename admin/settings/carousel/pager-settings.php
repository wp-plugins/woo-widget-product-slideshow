...
<?php
/*-----------------------------------------------------------------------------------
Slider Carousel Pager Settings
...
class WC_Product_Slider_Carousel_Pager_Settings extends WC_Product_Slider_Admin_UI
{
	 ...
	 */
	public $option_name = 'wc_product_slider_a3_carousel_pager_settings';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'wc_product_slider_a3_carousel_pager_settings';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_carousel_pager_settings_form',
		);
...
global $wc_product_slider_carousel_pager_settings;
$wc_product_slider_carousel_pager_settings = new WC_Product_Slider_Carousel_Pager_Settings();

/** 
 * wc_product_slider_carousel_pager_settings_form()
 * Define the callback function to show subtab content
 */
function wc_product_slider_carousel_pager_settings_form() {
	global $wc_product_slider_carousel_pager_settings;
	$wc_product_slider_carousel_pager_settings->settings_form();
}

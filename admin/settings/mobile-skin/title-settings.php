...
<?php
/*-----------------------------------------------------------------------------------
Slider Mobile Skin Title Settings
...
class WC_Product_Slider_Mobile_Skin_Title_Settings extends WC_Product_Slider_Admin_UI
{
	 ...
	 */
	public $option_name = 'wc_product_slider_a3_mobile_skin_title_settings';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'wc_product_slider_a3_mobile_skin_title_settings';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_mobile_skin_title_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
				'name'		=> __( 'Product Name Settings', 'wc_product_slider' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Product Name', 'wc_product_slider' ),
			...
			array(  
				'name' 		=> __( 'Title Font', 'wc_product_slider' ),
				'id' 		=> 'title_font',
				'type' 		=> 'typography',
				'default'	=> array( 'size' => '16px', 'face' => 'Arial, sans-serif', 'style' => 'normal', 'color' => '#6d6d6d' )
			),
			array(  
				'name' 		=> __( 'Title Margin', 'wc_product_slider' ),
				'id' 		=> 'title_margin',
...
global $wc_product_slider_mobile_skin_title_settings;
$wc_product_slider_mobile_skin_title_settings = new WC_Product_Slider_Mobile_Skin_Title_Settings();

/** 
 * wc_product_slider_mobile_skin_title_settings_form()
 * Define the callback function to show subtab content
 */
function wc_product_slider_mobile_skin_title_settings_form() {
	global $wc_product_slider_mobile_skin_title_settings;
	$wc_product_slider_mobile_skin_title_settings->settings_form();
}

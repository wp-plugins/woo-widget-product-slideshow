...
<?php
/*-----------------------------------------------------------------------------------
Slider Mobile Skin Price Settings
...
class WC_Product_Slider_Mobile_Skin_Price_Settings extends WC_Product_Slider_Admin_UI
{
	
	/**
	 * @var string
	 */
	private $parent_tab = 'price-mobile';
	 ...
	 */
	public $option_name = 'wc_product_slider_a3_mobile_skin_price_settings';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'wc_product_slider_a3_mobile_skin_price_settings';
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Price Settings successfully saved.', 'wc_product_slider' ),
				'error_message'		=> __( 'Error: Price Settings can not save.', 'wc_product_slider' ),
				'reset_message'		=> __( 'Price Settings successfully reseted.', 'wc_product_slider' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'price',
			'label'				=> __( 'Price', 'wc_product_slider' ),
			'callback_function'	=> 'wc_product_slider_mobile_skin_price_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
				'name'		=> __( 'Price Settings', 'wc_product_slider' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Price', 'wc_product_slider' ),
...
global $wc_product_slider_mobile_skin_price_settings;
$wc_product_slider_mobile_skin_price_settings = new WC_Product_Slider_Mobile_Skin_Price_Settings();

/** 
 * wc_product_slider_mobile_skin_price_settings_form()
 * Define the callback function to show subtab content
 */
function wc_product_slider_mobile_skin_price_settings_form() {
	global $wc_product_slider_mobile_skin_price_settings;
	$wc_product_slider_mobile_skin_price_settings->settings_form();
}

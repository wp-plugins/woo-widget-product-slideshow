...
<?php
/*-----------------------------------------------------------------------------------
Slider Widget Skin Global Settings
...
class WC_Product_Slider_Widget_Skin_Global_Settings extends WC_Product_Slider_Admin_UI
{
	 ...
	 */
	public $option_name = 'wc_product_slider_a3_widget_skin_global_settings';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'wc_product_slider_a3_widget_skin_global_settings';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_widget_skin_global_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
				'name' 		=> __( 'Widget Skin', 'wc_product_slider' ),
                'type' 		=> 'heading',
				'desc'		=> __( 'Use these Widget Skin settings to create your own custom Widget Slider Skin style and layout. Skins are selected and applied to every product slider when creating a Widget Slider or embedding in a post or page by the Slider shortcode feature.', 'wc_product_slider' ),
           	),
...
global $wc_product_slider_widget_skin_global_settings;
$wc_product_slider_widget_skin_global_settings = new WC_Product_Slider_Widget_Skin_Global_Settings();

/** 
 * wc_product_slider_widget_skin_global_settings_form()
 * Define the callback function to show subtab content
 */
function wc_product_slider_widget_skin_global_settings_form() {
	global $wc_product_slider_widget_skin_global_settings;
	$wc_product_slider_widget_skin_global_settings->settings_form();
}

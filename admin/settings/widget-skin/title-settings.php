...
class WC_Product_Slider_Widget_Skin_Title_Settings extends WC_Product_Slider_Admin_UI
{
	 ...
	 */
	public $option_name = 'wc_product_slider_a3_widget_skin_title_settings';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_widget_skin_title_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				'name' 		=> __( 'Product Name Position', 'wc_product_slider' ),
				'id' 		=> 'title_position',
				'type' 		=> 'select',
				'default'	=> 'bellow',
				'options'	=> array(
					'above'			=> __( 'Above Slider', 'wc_product_slider' ),
					'bellow'		=> __( 'Below Slider', 'wc_product_slider' ),
				),
				'css' 		=> 'width:160px;',
			),
			array(  
 ...
 */
function wc_product_slider_widget_skin_title_settings_form() {
	global $wc_product_slider_widget_skin_title_settings;
	$wc_product_slider_widget_skin_title_settings->settings_form();
}

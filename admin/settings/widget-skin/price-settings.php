...
class WC_Product_Slider_Widget_Skin_Price_Settings extends WC_Product_Slider_Admin_UI
{
	
	/**
	 * @var string
	 */
	private $parent_tab = 'price-widget';
	 ...
	 */
	public $option_name = 'wc_product_slider_a3_widget_skin_price_settings';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_widget_skin_price_settings_form',
		);
...
/** 
 * wc_product_slider_widget_skin_price_settings_form()
 * Define the callback function to show subtab content
 */
function wc_product_slider_widget_skin_price_settings_form() {
	global $wc_product_slider_widget_skin_price_settings;
	$wc_product_slider_widget_skin_price_settings->settings_form();
}

...
class WC_Product_Slider_Widget_Skin_Pager_Settings extends WC_Product_Slider_Admin_UI
{
	 ...
	 */
	public $option_name = 'wc_product_slider_a3_widget_skin_pager_settings';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_widget_skin_pager_settings_form',
		);
...
/** 
 * wc_product_slider_widget_skin_pager_settings_form()
 * Define the callback function to show subtab content
 */
function wc_product_slider_widget_skin_pager_settings_form() {
	global $wc_product_slider_widget_skin_pager_settings;
	$wc_product_slider_widget_skin_pager_settings->settings_form();
}

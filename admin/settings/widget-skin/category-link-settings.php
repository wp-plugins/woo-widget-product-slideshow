...
class WC_Product_Slider_Widget_Skin_Category_Link_Settings extends WC_Product_Slider_Admin_UI
{
	
	/**
	 * @var string
	 */
	private $parent_tab = 'category-link-widget';
	 ...
	 */
	public $option_name = 'wc_product_slider_a3_widget_skin_category_tag_link_settings';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_widget_skin_category_link_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				'name' 		=> __( 'Category Link Alignment', 'wc_product_slider' ),
			...
			array(  
				'name' 		=> __( 'Category Link Container Background Colour', 'a3_responsive_slider' ),
			...
			array(  
				'name' 		=> __( 'Category Link Container Border', 'a3_responsive_slider' ),
				'id' 		=> 'category_link_border',
				'type' 		=> 'border',
				'default'	=> array( 'width' => '0px', 'style' => 'solid', 'color' => '#000000', 'corner' => 'rounded' , 'rounded_value' => 0 )
			),
			array(  
				'name' 		=> __( 'Category Link Container Shadow', 'a3_responsive_slider' ),
			...
			array(  
				'name' 		=> __( 'Tag Link Alignment', 'wc_product_slider' ),
			...
			array(  
				'name' 		=> __( 'Tag Link Container Background Colour', 'a3_responsive_slider' ),
				'desc' 		=> __( 'Default', 'a3_responsive_slider' ) . ' [default_value]',
			...
			array(  
				'name' 		=> __( 'Tag Link Container Border', 'a3_responsive_slider' ),
				'id' 		=> 'tag_link_border',
				'type' 		=> 'border',
				'default'	=> array( 'width' => '0px', 'style' => 'solid', 'color' => '#000000', 'corner' => 'rounded' , 'rounded_value' => 0 )
			),
			array(  
				'name' 		=> __( 'Tag Link Container Shadow', 'a3_responsive_slider' ),
				'id' 		=> 'tag_link_shadow',
				'type' 		=> 'box_shadow',
				'default'	=> array( 'enable' => 0, 'h_shadow' => '5px' , 'v_shadow' => '5px', 'blur' => '2px' , 'spread' => '2px', 'color' => '#DBDBDB', 'inset' => '' )
			),
...
/** 
 * wc_product_slider_widget_skin_category_link_settings_form()
 * Define the callback function to show subtab content
 */
function wc_product_slider_widget_skin_category_link_settings_form() {
	global $wc_product_slider_widget_skin_category_link_settings;
	$wc_product_slider_widget_skin_category_link_settings->settings_form();
}

...
<?php
/*-----------------------------------------------------------------------------------
Slider Card Skin Pager Settings
...
class WC_Product_Slider_Card_Skin_Pager_Settings extends WC_Product_Slider_Admin_UI
{
	 ...
	 */
	public $option_name = 'wc_product_slider_a3_card_skin_pager_settings';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'wc_product_slider_a3_card_skin_pager_settings';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_card_skin_pager_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				'name' 		=> __( 'Pager Transition', 'wc_product_slider' ),
			...
			array(  
				'name' 		=> __( 'Pager Direction', 'wc_product_slider' ),
				...
				'checked_label'		=> __( 'Horizontal', 'wc_product_slider' ),
				'unchecked_label' 	=> __( 'Vertical', 'wc_product_slider' ),	
			),
			array(  
			...
			array(  
				'name' 		=> __( 'Pager Bullet Background Colour', 'wc_product_slider' ),
				'desc' 		=> __( 'Default', 'wc_product_slider' ) . ' [default_value]',
			...
			array(  
				'name' 		=> __( 'Pager Viewing Bullet Background Colour', 'wc_product_slider' ),
				'desc' 		=> __( 'Default', 'wc_product_slider' ) . ' [default_value]',
			...
			array(  
				'name' 		=> __( 'Pager Viewing Bullet Border', 'wc_product_slider' ),
				'id' 		=> 'pager_activate_item_border',
				'type' 		=> 'border',
				'default'	=> array( 'width' => '1px', 'style' => 'solid', 'color' => '#FFFFFF', 'corner' => 'rounded' , 'rounded_value' => 10 )
			),
			array(  
				'name' 		=> __( 'Pager Viewing Bullet Shadow', 'wc_product_slider' ),
...
global $wc_product_slider_card_skin_pager_settings;
$wc_product_slider_card_skin_pager_settings = new WC_Product_Slider_Card_Skin_Pager_Settings();

/** 
 * wc_product_slider_card_skin_pager_settings_form()
 * Define the callback function to show subtab content
 */
function wc_product_slider_card_skin_pager_settings_form() {
	global $wc_product_slider_card_skin_pager_settings;
	$wc_product_slider_card_skin_pager_settings->settings_form();
}

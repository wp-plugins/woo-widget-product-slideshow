...
class WC_Product_Slider_Admin_UI
{
	 ...
	 */
	public $pro_plugin_page_url = 'http://a3rev.com/shop/woocommerce-widget-product-slider/';
	
	public $slider_plugin_page_url = 'http://a3rev.com/shop/woocommerce-product-slider/';
	...
	public function upgrade_top_message( $echo = false, $setting_id = '' ) {
		$upgrade_top_message = sprintf( '<div class="pro_feature_top_message">' 
			...
			. '<br />' 
			. __( 'Upgrade to the <a href="%s" target="_blank">%s</a> to activate these settings.', 'wc_product_slider' ) 
			. '</div>'

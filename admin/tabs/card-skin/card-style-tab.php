...
<?php
/*-----------------------------------------------------------------------------------
Slider Card Skin Card Style Tab
...
class WC_Product_Slider_Card_Skin_Card_Style_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_card_skin_card_style_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/card-skin/card-style-settings.php' );
...
global $wc_product_slider_card_skin_card_style_tab;
$wc_product_slider_card_skin_card_style_tab = new WC_Product_Slider_Card_Skin_Card_Style_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_card_skin_card_style_tab_manager() {
	global $wc_product_slider_card_skin_card_style_tab;
	$wc_product_slider_card_skin_card_style_tab->tab_manager();
}

...
<?php
/*-----------------------------------------------------------------------------------
Slider Card Kin Description Tab
...
class WC_Product_Slider_Card_Skin_Description_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'label'				=> __( 'Description', 'wc_product_slider' ),
			'callback_function'	=> 'wc_product_slider_card_skin_description_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/card-skin/description-settings.php' );
...
global $wc_product_slider_card_skin_description_tab;
$wc_product_slider_card_skin_description_tab = new WC_Product_Slider_Card_Skin_Description_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_card_skin_description_tab_manager() {
	global $wc_product_slider_card_skin_description_tab;
	$wc_product_slider_card_skin_description_tab->tab_manager();
}

...
<?php
/*-----------------------------------------------------------------------------------
Slider Card Skin Footer Cell Tab
...
class WC_Product_Slider_Card_Skin_Footer_Cell_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_card_skin_footer_cell_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/card-skin/footer-cell-settings.php' );
...
global $wc_product_slider_card_skin_footer_cell_tab;
$wc_product_slider_card_skin_footer_cell_tab = new WC_Product_Slider_Card_Skin_Footer_Cell_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_card_skin_footer_cell_tab_manager() {
	global $wc_product_slider_card_skin_footer_cell_tab;
	$wc_product_slider_card_skin_footer_cell_tab->tab_manager();
}

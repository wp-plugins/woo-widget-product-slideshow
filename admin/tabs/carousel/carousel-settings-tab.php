...
<?php
/*-----------------------------------------------------------------------------------
Slider Carousel Global Settings Tab
...
class WC_Product_Slider_Carousel_Global_Settings_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	private $parent_page = 'wc-product-slider-carousel-page';
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_carousel_global_settings_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/carousel/carousel-settings.php' );
...
global $wc_product_slider_carousel_global_settings_tab;
$wc_product_slider_carousel_global_settings_tab = new WC_Product_Slider_Carousel_Global_Settings_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_carousel_global_settings_tab_manager() {
	global $wc_product_slider_carousel_global_settings_tab;
	$wc_product_slider_carousel_global_settings_tab->tab_manager();
}

...
class WC_Product_Slider_Carousel_Pager_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_carousel_pager_tab',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/carousel/pager-settings.php' );
...
global $wc_product_slider_carousel_pager_tab;
$wc_product_slider_carousel_pager_tab = new WC_Product_Slider_Carousel_Pager_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_carousel_pager_tab() {
	global $wc_product_slider_carousel_pager_tab;
	$wc_product_slider_carousel_pager_tab->tab_manager();
}

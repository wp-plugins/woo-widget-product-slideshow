...
class WC_Product_Slider_Carousel_Container_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'label'				=> __( 'Carousel Container', 'wc_product_slider' ),
			'callback_function'	=> 'wc_product_slider_carousel_container_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/carousel/container-settings.php' );
...
global $wc_product_slider_carousel_container_tab;
$wc_product_slider_carousel_container_tab = new WC_Product_Slider_Carousel_Container_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_carousel_container_tab_manager() {
	global $wc_product_slider_carousel_container_tab;
	$wc_product_slider_carousel_container_tab->tab_manager();
}

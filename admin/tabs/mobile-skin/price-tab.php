...
class WC_Product_Slider_Mobile_Skin_Price_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	private $parent_page = 'wc-product-slider-mobile-skin-page';
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_mobile_skin_price_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/mobile-skin/price-settings.php' );
...
global $wc_product_slider_mobile_skin_price_tab;
$wc_product_slider_mobile_skin_price_tab = new WC_Product_Slider_Mobile_Skin_Price_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_mobile_skin_price_tab_manager() {
	global $wc_product_slider_mobile_skin_price_tab;
	$wc_product_slider_mobile_skin_price_tab->tab_manager();
}

...
<?php
/*-----------------------------------------------------------------------------------
Slider Mobile Skin Category Link Tab
...
class WC_Product_Slider_Mobile_Skin_Category_Link_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			'name'				=> 'category-link-mobile',
			'label'				=> __( 'View All', 'wc_product_slider' ),
			'callback_function'	=> 'wc_product_slider_mobile_skin_category_link_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/mobile-skin/category-link-settings.php' );
...
global $wc_product_slider_mobile_skin_category_link_tab;
$wc_product_slider_mobile_skin_category_link_tab = new WC_Product_Slider_Mobile_Skin_Category_Link_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_mobile_skin_category_link_tab_manager() {
	global $wc_product_slider_mobile_skin_category_link_tab;
	$wc_product_slider_mobile_skin_category_link_tab->tab_manager();
}

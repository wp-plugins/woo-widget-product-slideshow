...
<?php
/*-----------------------------------------------------------------------------------
Slider Widget Skin Dimensions Tab
...
class WC_Product_Slider_Widget_Skin_Dimensions_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_widget_skin_dimensions_tab_manager',
		);
...
global $wc_product_slider_widget_skin_dimensions_tab;
$wc_product_slider_widget_skin_dimensions_tab = new WC_Product_Slider_Widget_Skin_Dimensions_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_widget_skin_dimensions_tab_manager() {
	global $wc_product_slider_widget_skin_dimensions_tab;
	$wc_product_slider_widget_skin_dimensions_tab->tab_manager();
}

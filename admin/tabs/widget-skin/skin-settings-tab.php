...
class WC_Product_Slider_Widget_Skin_Global_Settings_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
...
global $wc_product_slider_widget_skin_global_settings_tab;
$wc_product_slider_widget_skin_global_settings_tab = new WC_Product_Slider_Widget_Skin_Global_Settings_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_widget_skin_global_settings_tab_manager() {
	global $wc_product_slider_widget_skin_global_settings_tab;
	$wc_product_slider_widget_skin_global_settings_tab->tab_manager();
}

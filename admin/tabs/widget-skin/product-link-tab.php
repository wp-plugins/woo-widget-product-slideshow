...
<?php
/*-----------------------------------------------------------------------------------
Slider Widget Skin Product Link Tab
...
class WC_Product_Slider_Widget_Skin_Product_Link_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			'name'				=> 'product-link-widget',
			'label'				=> __( 'View Product', 'wc_product_slider' ),
			'callback_function'	=> 'wc_product_slider_widget_skin_product_link_tab_manager',
		);
...
global $wc_product_slider_widget_skin_product_link_tab;
$wc_product_slider_widget_skin_product_link_tab = new WC_Product_Slider_Widget_Skin_Product_Link_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_widget_skin_product_link_tab_manager() {
	global $wc_product_slider_widget_skin_product_link_tab;
	$wc_product_slider_widget_skin_product_link_tab->tab_manager();
}

...
<?php
/*-----------------------------------------------------------------------------------
Slider Widget Skin Controls Tab
...
class WC_Product_Slider_Widget_Skin_Control_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_widget_skin_control_tab_manager',
		);
	...
	public function tab_manager() {
		...
		$wc_product_slider_widget_skin_control_settings->settings_form();
...
global $wc_product_slider_widget_skin_control_tab;
$wc_product_slider_widget_skin_control_tab = new WC_Product_Slider_Widget_Skin_Control_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_widget_skin_control_tab_manager() {
	global $wc_product_slider_widget_skin_control_tab;
	$wc_product_slider_widget_skin_control_tab->tab_manager();
}

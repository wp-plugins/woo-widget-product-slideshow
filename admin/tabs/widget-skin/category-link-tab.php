...
<?php
/*-----------------------------------------------------------------------------------
Slider Widget Skin Category Link Tab
...
class WC_Product_Slider_Widget_Skin_Category_Link_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	private $parent_page = 'wc-product-slider-widget-skin-page';
	...
	public function tab_data() {
		...
		$tab_data = array( 
			'name'				=> 'category-link-widget',
			'label'				=> __( 'View All', 'wc_product_slider' ),
			'callback_function'	=> 'wc_product_slider_widget_skin_category_link_tab_manager',
		);
...
global $wc_product_slider_widget_skin_category_link_tab;
$wc_product_slider_widget_skin_category_link_tab = new WC_Product_Slider_Widget_Skin_Category_Link_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_widget_skin_category_link_tab_manager() {
	global $wc_product_slider_widget_skin_category_link_tab;
	$wc_product_slider_widget_skin_category_link_tab->tab_manager();
}

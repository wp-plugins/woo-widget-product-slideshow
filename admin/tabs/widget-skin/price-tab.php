...
class WC_Product_Slider_Widget_Skin_Price_Tab extends WC_Product_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_product_slider_widget_skin_price_tab_manager',
		);
...
global $wc_product_slider_widget_skin_price_tab;
$wc_product_slider_widget_skin_price_tab = new WC_Product_Slider_Widget_Skin_Price_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function wc_product_slider_widget_skin_price_tab_manager() {
	global $wc_product_slider_widget_skin_price_tab;
	$wc_product_slider_widget_skin_price_tab->tab_manager();
}
